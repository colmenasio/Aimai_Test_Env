...
bool godot_interfaces__msg__rrc_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("godot_interfaces.msg._rrc_command.RRCCommand", full_classname_dest, 44) == 0);
  }
  godot_interfaces__msg__RRCCommand * ros_message = _ros_message;
  {  // gas
...
{
  /* NOTE(esteve): Call constructor of RRCCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("godot_interfaces.msg._rrc_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RRCCommand");
