...
static const _RRCPosition_type_support_symbol_names_t _RRCPosition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, godot_interfaces, msg, RRCPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, godot_interfaces, msg, RRCPosition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, godot_interfaces, msg, RRCPosition)() {
  return &::godot_interfaces::msg::rosidl_typesupport_c::RRCPosition_message_type_support_handle;
}
